# QWEN.md - Контекст проекта: Каталог сотрудников Planet Elektrica

## Обзор проекта

Это Vue 3 приложение для управления каталогом сотрудников компании "Planet Elektrica". Проект представляет собой интерактивный каталог с организационной структурой, позволяющий:

- Просматривать иерархическую структуру отделов/филиалов
- Управлять карточками сотрудников (контакты, фото, роли)
- Редактировать организационную структуру
- Настраивать роли и разрешения
- Работать с графиком работы филиалов
...
- **HTTP клиент:** Axios
- **Компоненты:** VueDatePicker (@vuepic/vue-datepicker)
- **Linting:** ESLint + Prettier
- **Контейнеризация:** Docker (nginx production-stage)
